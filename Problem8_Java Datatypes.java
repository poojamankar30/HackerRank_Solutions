...
Output Format: For each input variable N and appropriate primitive DATATTYPE, you must determine if the given primitives are capable of storing it. If yes, then print:
    ...
    public static void main(String []argh)
    {
        ...
        for(int i=0;i<t;i++)
        {
            ...
            try
            {
                ...
                //Complete the code
                if(x>=Short.MIN_VALUE && x<=Byte.MAX_VALUE)
